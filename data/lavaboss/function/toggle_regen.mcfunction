...
execute if score #RegenType lavaboss_RegenTimer matches 1001 run gamerule natural_health_regeneration false
execute if score #RegenType lavaboss_RegenTimer matches 1002 run gamerule natural_health_regeneration true
